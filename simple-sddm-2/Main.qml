...
Pane {
    ...
    function selectRandomVideo() {
        // Liste de vos vidéos
        var videoPath = Qt.resolvedUrl("/usr/share/sddm/themes/simple-sddm-2/Video")
        var videos = [
            "Deku.mp4", 
            "Gojo.mp4",
            "Goku.mp4",
        ...
        videoPlayer.source = videos[randomIndex];
        console.log("Vidéo sélectionnée : " + videos[randomIndex]);
    }
    ...
    MediaPlayer {
            ...
            // Ajoutez ces propriétés pour le débogage
            onErrorChanged: {
                console.log("Video Error: " + errorString)
            }
            Component.onCompleted: {
                console.log("Video source: " + source)
                console.log("Video exists: " + Qt.resolvedUrl(source).toString())
                play()  // Forcez le démarrage
            }
        }
        ...
        VideoOutput {
            ...
            // Ajoutez un arrière-plan de débogage
            Rectangle {
                anchors.fill: parent
                color: "red"
                opacity: 0.3
