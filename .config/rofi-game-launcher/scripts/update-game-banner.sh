...
update-banner() {
    ...
    local src=$(find $STEAM_DIR/appcache/librarycache/${appid} -type f -name 'library_hero.jpg' -print -quit)
    local title=$(find $STEAM_DIR/appcache/librarycache/${appid} -type f -name 'logo.png' -print -quit)
