...
StatCard {
    ...
    //  Brightness
    // ─────────────────────────────────────────────────────────────────────────
    property real _brightVal:  1.0
    property int  _brightMax:  100
    property bool _brightBusy: false

    // Écran externe via ddcutil (DDC/CI, VCP 0x10). ddcutil est lent → debounce
    // large + pas de polling (lecture au démarrage et à l'ouverture du dashboard).
    Process {
        id: brightRead; command: ["bash", "-c", "ddcutil getvcp 10 --brief 2>/dev/null"]; running: false
        stdout: SplitParser {
            onRead: function(line) {
                // "VCP 10 C <current> <max>"
                var p = line.trim().split(/\s+/)
                if (p.length >= 5 && p[0] === "VCP") {
                    var cur = parseInt(p[3]); var max = parseInt(p[4])
    ...
    Process {
        id: brightWrite
        command: ["bash", "-c", "ddcutil setvcp 10 " +
            Math.max(0, Math.round(root._brightVal * 100)) + " --noverify 2>/dev/null"]
        running: false
        onRunningChanged: if (!running) root._brightBusy = false
    }
    Timer { id: brightDebounce; interval: 300; repeat: false
    ...
    // Lance une application externe détachée (clic droit sur une tuile) et ferme le dashboard
    Process { id: launchProc; running: false }
    function _launch(cmd) {
        Popups.dashboardOpen = false
        launchProc.command = ["bash", "-c", "setsid -f " + cmd + " >/dev/null 2>&1"]
...
// ─────────────────────────────────────────────────────────────────────────
    ...
    Connections {
        ...
        function onDashboardOpenChanged() {
            ...
            else if (!root._brightBusy) brightRead.running = true
        }
    }
    ...
    Column {
        ...
        Item {
            ...
            Text {
                ...
                color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.7)
            }
            ...
            Row {
                ...
                Text {
                    ...
                    color: Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.35)
                }
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        color: Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.12)
                        Rectangle {
                            anchors { left: parent.left; top: parent.top; bottom: parent.bottom }
                            width: Math.max(parent.radius * 2, parent.width * root._brightVal)
                            radius: parent.radius; color: Appearance.active
                ...
                Text {
                    ...
                    color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.75)
                }
            }
        }
        ...
        Item {
            ...
            Flickable {
                ...
                component TglBtn: Rectangle {
                    ...
                    radius: 10
                    color: on
                        ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.14)
                        : bH.hovered
                            ? Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.08)
                            : Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.04)
                    border.color: on
                        ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.30)
                        : Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.10)
                    border.width: 1
                    ...
                    Rectangle {
                        ...
                        color: btn.on ? Appearance.active : Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.18)
                        Behavior on color { ColorAnimation { duration: 130 } }
                    }
                    ...
                    Column {
                        ...
                        Text {
                            ...
                            color: btn.on ? Appearance.active : Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.40)
                            Behavior on color { ColorAnimation { duration: 130 } }
                        }
                        Text {
                            text: btn.label; font.pixelSize: 9; font.weight: Font.Medium
                            color: btn.on ? Appearance.text : Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.45)
                            Behavior on color { ColorAnimation { duration: 130 } }
                        }
                        Text {
                            ...
                            color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.65)
                    ...
                    MouseArea {
                        ...
                        onClicked: (m) => m.button === Qt.RightButton ? btn.rightClicked() : btn.toggled()
                    }
                }
                ...
                Grid {
                    ...
                    TglBtn {
                        ...
                        onRightClicked: root._launch("nm-connection-editor")
                    }
                    TglBtn {
                        width: tileGrid.btnW; height: tileGrid.btnH
    ...
    Rectangle {
        ...
        color: Qt.rgba(
            Math.min(1, Appearance.background.r + 0.05),
            Math.min(1, Appearance.background.g + 0.05),
            Math.min(1, Appearance.background.b + 0.05),
            0.98)
        border.color: Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.10)
        border.width: 1
        ...
        Flickable {
            ...
            Column {
                ...
                Rectangle {
                    ...
                    color: isActive
                        ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.14)
                        : offH.hovered ? Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.07) : "transparent"
                    ...
                    Row {
                        ...
                        Text {
                            ...
                            font.pixelSize: 9
                            color: parent.parent.isActive ? Appearance.active : Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.30)
                            anchors.verticalCenter: parent.verticalCenter
                            Behavior on color { ColorAnimation { duration: 100 } }
                        }
                        Text {
                            text:           "Off"
                            font.pixelSize: 12
                            color: parent.parent.isActive ? Appearance.active : Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.65)
                            anchors.verticalCenter: parent.verticalCenter
                            Behavior on color { ColorAnimation { duration: 100 } }
                        }
                    }
                ...
                Rectangle {
                    width: parent.width; height: 1
                    color: Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.07)
                }
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        color: isActive
                            ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.14)
                            : itemH.hovered ? Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.07) : "transparent"
                        Behavior on color { ColorAnimation { duration: 100 } }
                ...
                Text {
                    ...
                    text:    "Loading…"
                    font.pixelSize: 11
                    color:   Qt.rgba(Appearance.text.r, Appearance.text.g, Appearance.text.b, 0.25)
