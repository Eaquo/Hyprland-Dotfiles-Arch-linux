...
Item {
    ...
    component ChannelColumn: Item {
        ...
        Column {
            ...
            Text {
                anchors.horizontalCenter: parent.horizontalCenter
                text:           col.pctText
                color:          col.muted ? Qt.rgba(1,1,1,0.25) : Appearance.text
                font.pixelSize: 13
                font.bold:      true
            ...
            Item {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        color:  col.muted ? Qt.rgba(1,1,1,0.15) : Appearance.active
                        Behavior on color  { ColorAnimation  { duration: 150 } }
            ...
            Rectangle {
                ...
                Row {
                    ...
                    Text {
                        text:           col.icon
                        font.pixelSize: 13
                        color:          col.muted ? Appearance.active : Qt.rgba(1,1,1,0.55)
                        anchors.verticalCenter: parent.verticalCenter
                        Behavior on color { ColorAnimation { duration: 150 } }
                    }
                    Text {
                        ...
                        font.pixelSize: 11
                        color:          col.muted ? Appearance.active : Qt.rgba(1,1,1,0.4)
                        anchors.verticalCenter: parent.verticalCenter
                        Behavior on color { ColorAnimation { duration: 150 } }
                    }
                }
    ...
    component DeviceRow: Item {
        ...
        Rectangle {
            anchors.fill: parent
            radius: Appearance.cornerRadius - 4
            color:  row.isDefault
        ...
        Row {
            ...
            Rectangle {
                ...
                anchors.verticalCenter: parent.verticalCenter
                color: row.isDefault ? Appearance.active : Qt.rgba(1,1,1,0.2)
                Behavior on color { ColorAnimation { duration: 150 } }
            }

            Text {
                text:           row.label
                color:          row.isDefault ? Appearance.text : Qt.rgba(1,1,1,0.5)
                font.pixelSize: 11
                elide:          Text.ElideRight
