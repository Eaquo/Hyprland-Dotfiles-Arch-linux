...
Item {
    ...
    Row {
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                Rectangle {
                    anchors.fill: parent; radius: Appearance.cornerRadius
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            Text {
                                ...
                                text: colItem.cLabel; color: Appearance.active
                                font.pixelSize: 12; font.weight: Font.DemiBold
                            }
                            Rectangle {
                                anchors.verticalCenter: parent.verticalCenter
                                width: cntT.implicitWidth + 10; height: 16; radius: 8
                                color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.12)
                                Text {
                                    id: cntT; anchors.centerIn: parent
                                    text: colItem.cTasks.length
                                    color: Appearance.active; font.pixelSize: 9; font.weight: Font.Bold
                                }
                            }
                        }
                        ...
                        Rectangle {
                            ...
                            color: addH.hovered
                                ...
                                : Qt.rgba(1, 1, 1, 0.05)
                            border.color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.20)
                            border.width: 1
                            Behavior on color { ColorAnimation { duration: 100 } }
                            Text { anchors.centerIn: parent; text: "+"; color: Appearance.active; font.pixelSize: 15 }
                    ...
                    Item {
                        ...
                        Item {
                            ...
                            Rectangle {
                                ...
                                radius: 8
                                color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.06)
                                border.color: draftInput.activeFocus
                                    ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.50)
                                    : Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.22)
                                border.width: 1
                                ...
                                TextInput {
                                    ...
                                    color: Appearance.text; font.pixelSize: 12
                                    wrapMode: TextInput.WordWrap
                                    selectionColor: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.35)
    ...
    Rectangle {
        ...
        color: Qt.rgba(
            Math.min(1, Appearance.background.r + 0.06),
            Math.min(1, Appearance.background.g + 0.06),
            Math.min(1, Appearance.background.b + 0.06), 0.98)
        ...
        Column {
            ...
            Item {
                ...
                Text {
                    ...
                    color: Appearance.text; font.pixelSize: 11; font.weight: Font.DemiBold
                }
                Text {
                    anchors { right: parent.right; verticalCenter: parent.verticalCenter }
                    text: "›"; font.pixelSize: 17
                ...
                Repeater {
                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            ...
                            color: isSel
                                ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.82)
                                : isNow ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.12)
                                        : dayH.hovered && modelData.cur ? Qt.rgba(1,1,1,0.08) : "transparent"
                            border.color: isNow && !isSel ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.35) : "transparent"
                            border.width: 1
                            Behavior on color { ColorAnimation { duration: 80 } }
                            ...
                            Text {
                                ...
                                color: isSel ? Appearance.background
            ...
            Item {
                ...
                Row {
                    ...
                    Row {
                        ...
                        Text { anchors.verticalCenter: parent.verticalCenter; text: ":"; font.pixelSize: 15; font.weight: Font.Bold; color: Appearance.text }
                    ...
                    Rectangle {
                        ...
                        color: addTH.hovered
                            ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.15)
                            : Qt.rgba(1,1,1,0.06)
                        border.color: Qt.rgba(1,1,1,0.10); border.width: 1
                        Behavior on color { ColorAnimation { duration: 80 } }
                        Text {
                            ...
                            color: addTH.hovered ? Appearance.active : Qt.rgba(1,1,1,0.45)
                            Behavior on color { ColorAnimation { duration: 80 } }
                        }
            ...
            Row {
                ...
                Rectangle {
                    width: 86; height: 28; radius: 8
                    color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, doneH.hovered ? 0.28 : 0.16)
                    border.color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.38); border.width: 1
                    Behavior on color { ColorAnimation { duration: 80 } }
                    Text {
                        anchors.centerIn: parent; text: "Done"
                        font.pixelSize: 11; font.weight: Font.Medium; color: Appearance.active
                    }
        ...
        Rectangle {
            ...
            Column {
                ...
                TextInput {
                    ...
                    color:          Appearance.text; font.pixelSize: 12; font.weight: Font.Medium
                    wrapMode:       TextInput.WordWrap
                    selectionColor: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.35)
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            Text {
                                ...
                                color: (card.taskData.dueDate || "") !== "" ? Appearance.active : Qt.rgba(1,1,1,0.40)
                                Behavior on color { ColorAnimation { duration: 80 } }
                            }
            ...
            Rectangle {
                ...
                color: Qt.rgba(
                    ...
                    Math.min(1, Appearance.background.b + 0.05), 0.96)

                Column {
                    anchors.centerIn: parent; spacing: 10
                    Text {
                        anchors.horizontalCenter: parent.horizontalCenter
                        text: "Delete task?"; color: Appearance.text; font.pixelSize: 12; font.weight: Font.Medium
                    }
                    Row {
