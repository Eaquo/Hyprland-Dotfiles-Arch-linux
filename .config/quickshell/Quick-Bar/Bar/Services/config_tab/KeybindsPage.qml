...
Item {
    ...
    Rectangle {
        ...
        clip:   true
        color:  Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.07)
        ...
        Row {
            ...
            Text {
                ...
                font.pixelSize: 11
                color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.70)
            }
            ...
            Rectangle {
                ...
                color: _saveH.hovered
                    ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.28)
                    : Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.16)
                border.color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.42)
                border.width: 1
                Behavior on color { ColorAnimation { duration: 100 } }
                Text { anchors.centerIn: parent; text: "Save"; font.pixelSize: 10
                    font.weight: Font.Medium; color: Appearance.active }
    ...
    component BindRow: Item {
        ...
        Rectangle {
            ...
            color: br.isCapturing
                ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.07)
                : _rH.hovered ? Qt.rgba(1, 1, 1, 0.04) : "transparent"
            border.color: br._savedDupe
                ? Qt.rgba(248/255, 113/255, 113/255, 0.35)
                : br.isCapturing
                    ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.20)
                    : "transparent"
            border.width: 1
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Text { anchors.centerIn: parent; text: "↺"; font.pixelSize: 11
                        color: _rstH.hovered ? Appearance.active : Qt.rgba(1,1,1,0.28) }
                ...
                Rectangle {
                    ...
                    color: (_pillH.hovered && br._interactive)
                        ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.16)
                        : Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.08)
                    border.color: br._isPending
                        ? Qt.rgba(1.0, 0.74, 0.22, 0.55)
                        : Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.24)
                    border.width: 1
                    ...
                    Text {
                        ...
                        color: br._isPending ? Qt.rgba(1.0, 0.74, 0.22, 1.0) : Appearance.active
            ...
            Item {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        color:  Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.08)
                        border.color: br._hasConflict
                            ? Qt.rgba(248/255, 113/255, 113/255, 0.55)
                            : Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b,
                        ...
                        Text {
                            ...
                            color: br._hasConflict
                                ...
                                : br.capturedKey !== ""
                                    ? Appearance.active
                                    : Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.45)
                            text: {
                                if (br.capturedKey !== "")
