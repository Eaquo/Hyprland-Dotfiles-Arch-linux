        ...
        Item {
            ...
            Column {
                ...
                Text {
                    ...
                    color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.3)
                }
                Text {
                    anchors.horizontalCenter: parent.horizontalCenter
                    text:           "Loading apps…"
                    ...
                    Row {
                        ...
                        Item {
                            ...
                            Rectangle {
                                anchors.fill: parent
                                radius:       7
                                color: Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.18)
                        ...
                        Text {
                            ...
                            text:           modelData.name
                            font.pixelSize: 13
                            color:          isSel ? Appearance.active : Appearance.text
            ...
            Row {
                ...
                Text {
                    ...
                    color: searchInput.activeFocus
                           ? Qt.rgba(Appearance.active.r, Appearance.active.g, Appearance.active.b, 0.7)
                           : Qt.rgba(1,1,1,0.35)
